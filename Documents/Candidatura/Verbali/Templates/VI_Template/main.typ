#set page(
  ...
  header: context {
    if counter(page).get().first() > 1 [
      ...
      text("Verbale Interno del 2025-mm-dd")
      )
    ]
  }
)
...
#align(center, text(weight: 600, size: 24pt, "Verbale Interno del 2025-mm-dd"))
...
#table(
  ...
  [#link("https://github.com/7Commits/SWE/issues/", "#")],[Descrizione Issue GitHub], [Nome],
  [#link("https://github.com/7Commits/SWE/issues/", "#")],[Descrizione Issue GitHub], [Nome]
)